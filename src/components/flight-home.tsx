...
export function FlightHome({ platform = false }: { platform?: boolean }) {
  ...
  return <div className="flight-home space-y-9">
    <div className="home-greeting"><p>{hour < 12 ? "Good morning" : hour < 18 ? "Good afternoon" : "Good evening"}{displayName ? `, ${displayName}` : ""}.</p><FlightStats /></div>
