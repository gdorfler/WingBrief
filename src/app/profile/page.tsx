...
import { NameForm } from "@/components/name-onboarding";
...
export default function ProfilePage() {
  ...
  return <div className="space-y-9">
    <section className="pilot-profile">
      ...
      <div className="pilot-profile-copy"><p className="flight-eyebrow">YOUR AVIATOR RECORD</p><h1>{displayName || "Your flight record"}</h1><p>{rankForLevel(record.level.level)} · Every flight adds to your story.</p><FlightStats/>
