...
/**
 * A course's dashboard.
 *
 * Everything here is scoped to whichever course is active: today's plan, the
 * unit standing, the weak concepts, that course's explainers. The platform
 * entry point at / deliberately carries none of it — a student arriving at
 * WingBrief is choosing a course, not already inside one.
 *
 * Navigation and Weather diverge here rather than at the entry, because what
 * differs between them is how a *course* reports progress, not how the
 * platform does.
 */
...
import { levelFromXp, liveStreak, rankForLevel } from "@/lib/xp";
