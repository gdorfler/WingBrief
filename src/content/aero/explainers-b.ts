...
export const EXPLAINERS_B: Explainer[] = [
  ...
  },
  {
    ...
    diagram: { id: "left-turning" },
    frames: [
      { caption: "Torque rolls the fuselage opposite the propeller.", hold: 3000, props: { effect: "torque", verdict: true } },
      { caption: "Slipstream swirl strikes the vertical stabiliser's left side.", hold: 3200, props: { effect: "slipstream", verdict: false } },
      { caption: "That pulls the tail right, yawing the nose LEFT.", hold: 3000, props: { effect: "slipstream", verdict: true } },
      { caption: "P-factor: the descending blade bites harder at high AOA.", hold: 3200, props: { effect: "pfactor", verdict: true } },
      { caption: "Gyroscopic precession acts 90° later in the rotation.", hold: 3200, props: { effect: "gyro", verdict: true } },
      { caption: "Four different mechanisms, one answer.", hold: 3400, props: { effect: "all", verdict: false } },
    ],
    predict: {
      at: 1,
      question:
