...
export const LESSONS_C: Lesson[] = [
  ...
  {
    id: "wl25b-reading-a-metar",
    unit: "w10",
    index: 26,
    title: "Reading a METAR",
    subtitle: "Eleven groups, always in the same order",
    estimatedMinutes: 7,
    mapIcon: "wx-metar",
    enablingObjectives: [],
    conceptIds: ["wx-metar-groups", "wx-metar-speci"],
    masteryThreshold: 0.85,
    screens: [
      {
        kind: "hook",
        headline: "Knowing what METAR stands for has never answered a question",
        line: "The objective says INTERPRET. Someone hands you the string and asks what the weather is.",
      },
      {
        kind: "model",
        headline: "The report, group by group",
        diagram: { id: "wx-metar-decode", props: { group: "none" } },
        line: "A METAR is positional. The same four digits mean different things depending on which slot they sit in.",
      },
      {
        kind: "manipulate",
        headline: "Take it apart",
        widget: "MetarGroupStepper",
        line: "Step the groups. Watch how the visibility group forces the present-weather group to exist.",
      },
      {
        kind: "chain",
        headline: "The groups corroborate each other",
        nodes: [
          { label: "19/18 — one degree of spread", trend: "none" },
          { label: "Air is saturated", trend: "none" },
          { label: "DZ FG — drizzle and fog", trend: "none" },
          { label: "7/8SM — visibility collapses", trend: "down", emphasis: true },
        ],
        footnote:
          "A report that does not hang together is a report you have misread. Below 7 SM an obstruction to vision MUST also be reported, and here it is.",
      },
      {
        kind: "compare",
        headline: "METAR or SPECI",
        columns: ["METAR", "SPECI"],
        rows: [
          { label: "Schedule", a: "Hourly, routine", b: "Unscheduled" },
          { label: "Window", a: "55 to 59 past the hour", b: "As soon as possible after the change" },
          { label: "Trigger", a: "The clock", b: "Critical data changed" },
          { label: "Contents", a: "Full body plus remarks", b: "The same elements" },
        ],
      },
      {
        kind: "anchor",
        headline: "Know Cold",
        statements: [
          "Ceiling = lowest BROKEN or OVERCAST. Scattered never counts",
          "Wind: three digits direction, then speed, then KT. Always FROM",
          "Sky: three letters coverage, three digits hundreds of feet AGL",
          "A2997 = 29.97 inHg — decimal after the second digit",
          "Below 7 SM, an obstruction to vision must also be reported",
        ],
      },
      { kind: "question", questionId: "wq-dec-002" },
      { kind: "question", questionId: "wq-dec-001" },
      { kind: "question", questionId: "wq-dec-004" },
      { kind: "question", questionId: "wq-dec-005" },
      { kind: "question", questionId: "wq-dec-006" },
    ],
    questionIds: [
      "wq-dec-001", "wq-dec-002", "wq-dec-003", "wq-dec-004",
      "wq-dec-005", "wq-dec-006", "wq-dec-007", "wq-dec-008",
    ],
    memorize: [
      "Ceiling is the lowest BKN or OVC. SCT000 is not a ceiling.",
      "METAR window: xx:55 to xx:59. SPECI when something changed.",
    ],
    sourceReferences: [TG("Weather Products")],
    labIds: ["wxlab-products"],
  },
  {
    id: "wl25c-reading-a-taf",
    unit: "w10",
    index: 27,
    title: "Reading a TAF",
    subtitle: "Three change groups, and only one of them lets go",
    estimatedMinutes: 7,
    mapIcon: "wx-taf",
    enablingObjectives: [],
    conceptIds: ["wx-taf-change-groups", "wx-taf-differences"],
    masteryThreshold: 0.85,
    screens: [
      {
        kind: "hook",
        headline: "A TAF is several forecasts stacked on one another",
        line: "The skill is knowing which line is in force at the time you care about.",
      },
      {
        kind: "model",
        headline: "One forecast, four lines",
        diagram: { id: "wx-taf-decode", props: { line: "none" } },
        line: "Every line after the first is a change group, and each one answers two questions: how fast, and does it stick.",
      },
      {
        kind: "manipulate",
        headline: "Work the change groups",
        widget: "TafChangeGroupPicker",
        line: "FM supersedes everything. BECMG changes only what it lists. TEMPO is the only one that lets go.",
      },
      {
        kind: "compare",
        headline: "Military against U.S. civil",
        line: "Four differences, and the first one changes the numbers rather than the layout.",
        columns: ["U.S. military", "U.S. civil"],
        rows: [
          { label: "Visibility", a: "Metres — 9000 is 6 miles", b: "Statute miles" },
          { label: "Transmission time", a: "Not shown before the period", b: "Included before the period" },
          { label: "Probability groups", a: "Not used", b: "PROB may appear" },
          { label: "Amendments", a: "Remark on the last line", b: "Modifier in the heading" },
          { label: "Altimeter", a: "QNH____INS", b: "Generally not forecast" },
        ],
      },
      {
        kind: "anchor",
        headline: "Know Cold",
        statements: [
          "FM — fast, permanent, carries ALL elements",
          "BECMG — slow, permanent, carries only what changes",
          "TEMPO — brief, temporary, supersedes nothing",
          "Periods run up to but NOT including the end time",
          "9999 = 7 miles or more. Military metres, civil statute miles",
        ],
      },
      { kind: "question", questionId: "wq-dec-011" },
      { kind: "question", questionId: "wq-dec-009" },
      { kind: "question", questionId: "wq-dec-010" },
      { kind: "question", questionId: "wq-dec-013" },
      { kind: "question", questionId: "wq-dec-014" },
    ],
    questionIds: [
      "wq-dec-009", "wq-dec-010", "wq-dec-011",
      "wq-dec-012", "wq-dec-013", "wq-dec-014",
    ],
    memorize: [
      "FM replaces everything. BECMG replaces what it names. TEMPO replaces nothing.",
      "Military TAFs use metres; 9000 is six miles.",
    ],
    sourceReferences: [TG("Weather Products")],
    labIds: ["wxlab-products"],
  },
