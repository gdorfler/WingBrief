 ...
 *
 * These definitions were originally written from the condensed notes, which is
 * all that was available at the time. The trainee guide has since been supplied
 * and is now the authority: every concept carries the enabling objectives it
 * satisfies, drawn from the 2.199–2.279 block. The chapter labels still name
 * the condensed-notes section each definition's wording came from, because the
 * two agree and the notes are the tighter phrasing.
 *
 * Material the guide covers and the notes do not lives in concepts-b.ts.
 */

/**
 * The Weather Trainee Guide is the authority (source hierarchy level 1). The
 * chapter label keeps the condensed-notes block the definition was drawn from,
 * because that is the wording these concepts use.
 */
const NOTES = (chapter: string, eo: string[]) => ({
  document: "Weather Trainee Guide" as const,
  chapter,
  eo,
});
const DUMP = (eo: string[]) => ({
...
export const CONCEPTS: Concept[] = [
  ...
  /* ================================================================ */
  {
    ...
    source: NOTES("WX 1: Theory", ["2.199","2.202"]),
  },
  {
    id: "wx-tropopause",
    unit: "w1",
    ...
    source: NOTES("WX 1: Theory", ["2.200","2.203"]),
  },
  {
    id: "wx-heat-exchange",
    unit: "w1",
    ...
    source: NOTES("WX 1: Theory", ["2.214"]),
  },
  {
    ...
    source: NOTES("WX 1: Theory", ["2.207","2.208"]),
  },
  {
    ...
    source: NOTES("WX 1: Theory", ["2.209"]),
  },
  {
    id: "wx-lapse-rate",
    unit: "w1",
    ...
    source: NOTES("WX 1: Theory", ["2.205","2.206"]),
  },
  {
    id: "wx-slp-sp",
    unit: "w1",
    ...
    source: NOTES("WX 1: Theory", ["2.210"]),
  },
  {
    id: "wx-pgf",
    unit: "w1",
  ...
  /* ================================================================ */
  {
    ...
    source: NOTES("WX 1: Theory", ["2.211", "2.36"]),
  },
  {
    id: "wx-true-altitude",
    unit: "w2",
    ...
    source: NOTES("WX 1: Theory", ["2.211"]),
  },
  {
  ...
  },
  {
    ...
    source: NOTES("WX 1: Theory", ["2.212"]),
  },
  {
    ...
    source: NOTES("WX 1: Theory", ["2.213"]),
  },
  ...
  /* ================================================================ */
  {
    ...
    source: NOTES("WX 1: Theory", ["2.223"]),
  },
  {
    ...
    source: NOTES("WX 1: Theory", ["2.224","2.226"]),
  },
  {
    ...
    source: NOTES("WX 1: Theory", ["2.225"]),
  },
  {
    id: "wx-air-mass",
    unit: "w3",
    ...
    source: NOTES("WX 1: Theory", ["2.235"]),
  },
  {
    id: "wx-air-stability",
    unit: "w3",
    ...
    source: NOTES("WX 2: Mechanics", ["2.231"]),
  },
  {
    id: "wx-inversion",
    unit: "w3",
    ...
    source: NOTES("WX 1: Theory", ["2.213","2.254"]),
  },
  ...
  /* ================================================================ */
  {
    ...
    source: NOTES("WX 2: Mechanics", ["2.215"]),
  },
  {
    id: "wx-surface-wind",
    unit: "w4",
    ...
    source: NOTES("WX 2: Mechanics", ["2.216"]),
  },
  {
    id: "wx-buys-ballot",
    unit: "w4",
  ...
  },
  {
    ...
    source: NOTES("WX 2: Mechanics", ["2.218","2.219"]),
  },
  {
    id: "wx-jet-stream",
    unit: "w4",
    ...
    source: NOTES("WX 2: Mechanics", ["2.217"]),
  },
  ...
  /* ================================================================ */
  {
    ...
    source: NOTES("WX 2: Mechanics", ["2.229"]),
  },
  {
    ...
    source: NOTES("WX 2: Mechanics", ["2.230"]),
  },
  {
  ...
  },
  {
    ...
    source: NOTES("WX 2: Mechanics", ["2.227"]),
  },
  ...
  /* ================================================================ */
  {
    ...
    source: NOTES("WX 2: Mechanics", ["2.237", "2.240"]),
  },
  {
    id: "wx-warm-front",
    unit: "w6",
    ...
    source: NOTES("WX 2: Mechanics", ["2.242"]),
  },
  {
    ...
    source: NOTES("WX 2: Mechanics", ["2.243"]),
  },
  {
    ...
    source: NOTES("WX 2: Mechanics", ["2.244"]),
  },
  {
    ...
    source: NOTES("WX 2: Mechanics", ["2.236", "2.238"]),
  },
  ...
  /* ================================================================ */
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.246"]),
  },
  {
  ...
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.248"]),
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.249", "2.250", "2.253", "2.254"]),
  },
  {
    id: "wx-wind-shear",
    unit: "w7",
    ...
    source: NOTES("WX 3: Hazards", ["2.254", "2.255"]),
  },
  {
    id: "wx-shear-sources",
    unit: "w7",
  ...
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.249"]),
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.253"]),
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.250"]),
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.256"]),
  },
  ...
  /* ================================================================ */
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.258"]),
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.257", "2.259"]),
  },
  {
    id: "wx-clear-ice",
    unit: "w8",
    ...
    source: NOTES("WX 3: Hazards", ["2.265"]),
  },
  {
    id: "wx-rime-ice",
    unit: "w8",
  ...
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.262"]),
  },
  {
    id: "wx-icing-effects",
    unit: "w8",
    ...
    source: NOTES("WX 3: Hazards", ["2.261"]),
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.263"]),
  },
  ...
  /* ================================================================ */
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.273"]),
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.276"]),
  },
  {
    id: "wx-microburst",
    unit: "w9",
    ...
    source: NOTES("WX 3: Hazards", ["2.274"]),
  },
  {
    ...
    source: NOTES("WX 3: Hazards", ["2.267"]),
  },
  {
    id: "wx-fog",
    unit: "w9",
    ...
    source: NOTES("WX 3: Hazards", ["2.269", "2.270"]),
  },
  ...
  /* ================================================================ */
  {
    ...
    source: NOTES("WX 4: Planning and Resources", ["2.268"]),
  },
  {
    id: "wx-station-model",
    unit: "w10",
    ...
    source: NOTES("WX 4: Planning and Resources", ["4.26"]),
  },
  {
    id: "wx-metar",
    unit: "w10",
    ...
    source: NOTES("WX 4: Planning and Resources", ["4.18", "4.19"]),
  },
  {
    id: "wx-taf",
    unit: "w10",
    ...
    source: NOTES("WX 4: Planning and Resources", ["4.20", "4.22"]),
  },
  {
    id: "wx-pirep",
    unit: "w10",
    ...
    relationships: ["IWRUM"],
    source: NOTES("WX 4: Planning and Resources", ["2.279"]),
  },
  {
    ...
    source: NOTES("WX 4: Planning and Resources", ["4.23", "4.24"]),
  },
  {
    ...
    source: NOTES("WX 4: Planning and Resources", ["4.25"]),
  },
  {
    ...
    source: NOTES("WX 4: Planning and Resources", ["4.27", "4.28"]),
  },
  {
    id: "wx-winds-aloft",
    unit: "w10",
    ...
    source: NOTES("WX 4: Planning and Resources", ["4.29", "4.30"]),
  },
  {
    ...
    source: NOTES("WX 4: Planning and Resources", ["4.32"]),
  },
  {
    ...
    source: NOTES("WX 4: Planning and Resources", ["2.266"]),
  },
  {
    ...
    source: NOTES("WX 4: Planning and Resources", ["2.277", "2.278"]),
  },
  {
